...
*
* Purpose: actions and attributes for a class "House"
*
...
public class House {
	...
	public static double THRESHOLD = .000001;
	...
	public boolean equals(House h) {
		...
		if (this.color == h.color && (this.price - h.price) < THRESHOLD && (this.width - h.width) < THRESHOLD && (this.length - h.length) < THRESHOLD && (this.height - h.height) < THRESHOLD && this.forSale == h.forSale)
		{
			return true;
		}
